...
public class ActionSheetErrorDialog extends BottomBaseDialog<ActionSheetDialog> {
    ...
    public ActionSheetErrorDialog(Context context, ArrayList<DialogMenuItem> baseItems, View animateView) {
        super(context, animateView);
        mContents.addAll(baseItems);
        init();
    }

    public ActionSheetErrorDialog(Context context, String[] items, View animateView) {
        super(context, animateView);
    ...
    public ActionSheetErrorDialog(Context context, BaseAdapter adapter, View animateView) {
        super(context, animateView);
        mAdapter = adapter;
        init();
    }
    ...
    public View onCreateView() {
        ...
        Typeface font = Typeface.createFromAsset(getContext().getAssets(), "fonts/ProximaNova-Reg.otf");
    ...
    public ActionSheetErrorDialog titleBgColor(int titleBgColor) {
        mTitleBgColor = titleBgColor;
        return this;
    }

    public ActionSheetErrorDialog title(String title) {
        mTitle = title;
        return this;
    }

    public ActionSheetErrorDialog titleHeight(float titleHeight) {
        mTitleHeight = titleHeight;
        return this;
    }

    public ActionSheetErrorDialog titleTextSize_SP(float titleTextSize_SP) {
        mTitleTextSize = titleTextSize_SP;
        return this;
    }

    public ActionSheetErrorDialog titleTextColor(int titleTextColor) {
        mTitleTextColor = titleTextColor;
        return this;
    }

    public ActionSheetErrorDialog isTitleShow(boolean isTitleShow) {
        mIsTitleShow = isTitleShow;
        return this;
    }

    public ActionSheetErrorDialog lvBgColor(int lvBgColor) {
        mLvBgColor = lvBgColor;
        return this;
    }

    public ActionSheetErrorDialog cornerRadius(float cornerRadius_DP) {
        mCornerRadius = cornerRadius_DP;
        return this;
    }

    public ActionSheetErrorDialog dividerColor(int dividerColor) {
        mDividerColor = dividerColor;
        return this;
    }

    public ActionSheetErrorDialog dividerHeight(float dividerHeight_DP) {
        mDividerHeight = dividerHeight_DP;
        return this;
    }

    public ActionSheetErrorDialog itemPressColor(int itemPressColor) {
        mItemPressColor = itemPressColor;
        return this;
    }

    public ActionSheetErrorDialog itemTextColor(int itemTextColor) {
        mItemTextColor = itemTextColor;
        return this;
    }

    public ActionSheetErrorDialog itemTextSize(float itemTextSize_SP) {
        mItemTextSize = itemTextSize_SP;
        return this;
    }

    public ActionSheetErrorDialog itemHeight(float itemHeight_DP) {
        mItemHeight = itemHeight_DP;
        return this;
    }

    public ActionSheetErrorDialog layoutAnimation(LayoutAnimationController lac) {
        mLac = lac;
        return this;
    }

    public ActionSheetErrorDialog cancelText(String cancelText) {
        mCancelText = cancelText;
        return this;
    }

    public ActionSheetErrorDialog cancelText(int cancelTextColor) {
        mCancelTextColor = cancelTextColor;
        return this;
    }

    public ActionSheetErrorDialog cancelTextSize(float cancelTextSize) {
